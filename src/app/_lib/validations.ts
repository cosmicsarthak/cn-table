...
export const searchParamsCache = createSearchParamsCache({
  ...
  supplierPo: parseAsString.withDefault(""),
...
export const createOrderSchema = z.object({
  ...
  poValue: z.number().positive("PO value is required and must be greater than 0"),
...
export const updateOrderSchema = z.object({
  ...
  poValue: z.number().positive("PO value must be greater than 0").optional(),
