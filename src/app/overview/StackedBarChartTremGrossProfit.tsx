  ...
  return (
      <div className="flex flex-col gap-16">
        <div className="col-span-full sm:col-span-3 mb-8">
          <Label htmlFor="year-select-gross" className="font-medium">
            Select Year
          </Label>
          <Select
              name="year-select-gross"
              value={selectedYear}
              onValueChange={(value) => setSelectedYear(value)}
          >
            <SelectTrigger id="year-select-gross" className="mt-2">
        ...
        <div className="flex flex-col gap-4">
          <p className="mx-auto font-mono text-sm font-medium">
            Stacked <span className="bg-black font-bold p-2 uppercase rounded-xl border text-white">Gross Profit</span> for <span className="font-bold">{selectedYear}</span>
          </p>
          <BarChart
              type="stacked"
              className="h-80"
