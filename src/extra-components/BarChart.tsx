...
} from "@/extra-lib/chartUtils"
import { useOnWindowResize } from "@/extra-lib/useOnWindowResize"
import { cx } from "@/extra-lib/utils"
...
const renderShape = (
  ...
  return (
    <rect
      ...
      rx={5} // Increased border radius for more rounded corners
      ry={5} // Increased border radius for more rounded corners
    />
  )
}
    ...
    return (
      ...
      >
        ...
        <div className={cx("space-y-1 px-4 py-2")}>
          ...
          {/* Display the total value for the month */}
          <div className={cx("border-t border-inherit px-4 py-2 mt-2")}>
